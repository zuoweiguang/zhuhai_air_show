...
export default class MapControl extends Component {
    constructor(props, context) {
        ...
        this.onRegisterControlFlyEvent = this.onRegisterControlFlyEvent.bind(this)
        this.clearSelect = this.clearSelect.bind(this)
        this.updateButtonState = this.updateButtonState.bind(this)
        this.onRegisterOperateCancelEvent = this.onRegisterOperateCancelEvent.bind(this)
    ...
    /**操作记录回退*/
    onRegisterOperateCancelEvent(e) {
        ...
        if (ctrlKey && keyCode == 90) {
            operateHandler.cancelOperateRecord(actions)
        }
    }

    componentDidMount() {
        env.operateRecords = Array.of()
        let that = this
        document.onkeydown = function (event) {
            let e = window.event || event

            that.onRegisterControlFlyEvent(e)
            that.onRegisterOperateCancelEvent(e)
        }
    }
    ...
    render() {
        ...
        return <div>
            <div className="map-control-container" id="mapControl" style={{display:'none'}}>
