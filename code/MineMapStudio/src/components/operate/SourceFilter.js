...
import {OPERATE_SOLUTION_LAYER_FILTER_MODIFY} from '../../constants/OperateActionTypes'
...
export default class SourceFilter extends Component {
    ...
    handleCombineFilterChange(id, value) {
        ...
        let param = {
            oldValue: layerStyle.filter || [],
            newValue: filters,
            layer: this.props.layerStyle,
            solution: {}
        }
        operateHandler.addOperateRecord(OPERATE_SOLUTION_LAYER_FILTER_MODIFY, param)
