    ...
    handleChange(e) {
        ...
        switch (contentItem.type) {
            case "radio-group":
                ...
                } else if (target.defaultValue == 0 || target.defaultValue == -1){
                    this.props.handleStyleChange(contentItem.id, parseInt(target.defaultValue))
                } else {
                ...
                return <div className="content-item" style={contentItem.style}>
                    ...
                    <div className="item-body">
                        <input ref={contentItem.id} className="form-control input-sm" onChange={this.handleChange}
                               ...
                               disabled={contentItem.disabled} min={contentItem.min}/>
                    </div>
                </div>
            case "icon":
                this.renderIcon()
