...
public class BuildProtobufMR {
    ...
    public static class BuildPbfDriver extends Configured implements Tool{
        ...
        public int run(String[] args) throws Exception {
            ...
            String tablename = "Admin_Vectortile";
            if(args.length > 5){
                tablename = args[5];
            }
        ...
        public static Job getJob(Configuration cfg, String tilelistfile,
            ...
            Job job = Job.getInstance(cfg, "Build ProtoBuf to HBase");
