 ...
 */
public class MissingRoadDetectionTecentMR extends Configured implements Tool {


    public static class MissingRoadDetectionMapper extends
            TableMapper<ImmutableBytesWritable, Put> {
        public static final Logger logger = Logger.getLogger(MissingRoadDetectionTecentMR.class);
        ...
        public static String SOURCE_DIDI = "DD_TAXI";
        ...
        public void map(ImmutableBytesWritable rowkey, Result result,
            ...
            if (existRoad && existSource) {
                ...
                Map<String, Map<String, Object>> calculateResult1 = imageAlgorithm.CalEccentricityAndOrientation(region1, true, 0.9);
    ...
    public int run(String[] args) throws Exception {
        ...
        for (Element element : list) {
            if ("didi".equals(element.getName().trim())) {
        ...
        job.setJarByClass(MissingRoadDetectionTecentMR.class);
        ...
        TableMapReduceUtil.initTableMapperJob(road_table,
                roadScan, MissingRoadDetectionTecentMR.MissingRoadDetectionMapper.class,
                ImmutableBytesWritable.class, Put.class, job);
        TableMapReduceUtil.initTableReducerJob(target_table,
                MissingRoadDetectionTecentMR.MissingRoadDetectionReducer.class, job);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new MissingRoadDetectionTecentMR(), args);
        System.exit(res);
    }
    ...
    public static void azkabanRun(String road_table, String road_family, String traj_table, String traj_family,
        ...
        int res = ToolRunner.run(new Configuration(), new MissingRoadDetectionTecentMR(), new String[]{road_table, road_family, traj_table, traj_family,
