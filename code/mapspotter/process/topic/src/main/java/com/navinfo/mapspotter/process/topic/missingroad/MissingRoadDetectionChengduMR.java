 ...
 */
public class MissingRoadDetectionChengduMR extends Configured implements Tool {


    public static class MissingRoadDetectionMapper extends
            TableMapper<ImmutableBytesWritable, Put> {
        public static final Logger logger = Logger.getLogger(MissingRoadDetectionChengduMR.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(MissingRoadDetectionChengduMR.class);
        ...
        TableMapReduceUtil.initTableMapperJob(road_table,
                roadScan, MissingRoadDetectionChengduMR.MissingRoadDetectionMapper.class,
                ImmutableBytesWritable.class, Put.class, job);
        TableMapReduceUtil.initTableReducerJob(target_table,
                MissingRoadDetectionChengduMR.MissingRoadDetectionReducer.class, job);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new MissingRoadDetectionChengduMR(), args);
        System.exit(res);
    }
    ...
    public static void azkabanRun(String road_table, String road_family, String traj_table, String traj_family,
        ...
        int res = ToolRunner.run(new Configuration(), new MissingRoadDetectionChengduMR(), new String[]{road_table, road_family, traj_table, traj_family,
