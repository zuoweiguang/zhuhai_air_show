...
public class Hbase2Redis {
    private Logger logger = Logger.getLogger(Hbase2Redis.class);
    ...
    public Hbase2Redis(int redisDbNum){
    ...
    public void convert(String tablename, String colfamily, String column){
        ...
        logger.info("Convert 2 redis complete.");
    }
    ...
    public static void main(String[] args){
        ...
        Hbase2Redis hbase2Redis = new Hbase2Redis(redisDbNum);

        if(hbase2Redis.prepare()){
            //hbase2Redis.convert("Road_Vectortile", "Vectortile", "dig");
