...
public abstract class ServiceAbstract {
    ...
    public ServiceAbstract() {
        ...
        MongoPool mongoPool = pool.getZhuhaiMongoPool();
    ...
    public JSONArray queryJsonArray(String table_name) throws Exception {
        JSONArray array = new JSONArray();
        MongoDBCursor cursor = (MongoDBCursor) database.query(table_name);
