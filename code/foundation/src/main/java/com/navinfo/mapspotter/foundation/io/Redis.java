 ...
 */
public class Redis implements Connection, Cursor {

    private Jedis _conn = null; //Redis connection
     ...
     */
    @Override
    public int connect(ConnectParams params) throws Exception {
        try {
            String host = params.getHost();
            int port = params.getPort();
            // 创建连接
            _conn = new Jedis(host, port);
    ...
    public Object fetch() {
        ...
        return _scan.getResult().get(_index);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        param.setHost("192.168.4.128");
        param.setPort(6379);
        //param.setPassword("Navinfo1!");

        Redis redis = new Redis();
        int result = redis.connect(param);
        System.out.println(redis.query("string"));
        System.out.println(redis.query("list"));
        System.out.println(redis.query("hash"));
        System.out.println(redis.query("set"));
        System.out.println(redis.query("zset"));
        redis.close();
    }
}
