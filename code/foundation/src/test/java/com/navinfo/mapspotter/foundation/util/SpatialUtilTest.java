...
public class SpatialUtilTest {
    ...
    public void test(){
        ...
        Geometry Geo1 = SpatialUtil.CreateGeometryByWKT("LINESTRING(0 40, 60 40, 60 0, 40 0)");
        Geometry Geo2 = SpatialUtil.CreateGeometryByWKT("LINESTRING(0 0, 80 80)");
        Geometry Geo3 = SpatialUtil.CreateGeometryByWKT("POINT(10 10)");
        Geometry Geo4 = SpatialUtil.CreateGeometryByWKT("POLYGON((0 0,60 0,60 60 ,0 60,0 0))");
