...
export default class StyleLayoutSymbol extends Component {
    ...
    render() {
        ...
        return <div className="content-body">
            ...
            <StyleContentItem handleStyleChange={this.handleStyleChange}
                              contentItem={{title:"与文本匹配",type:"select",disabled:"disabled",id:"icon-text-fit",defaultValue:layerStyle.layout["icon-text-fit"]||"none",
                inputItems:[{title:"无",value:"none"},{title:"全部",value:"both"},
                {title:"宽度",value:"width"},{title:"高度",value:"height"}]}}/>
            <StyleContentItem handleStyleChange={this.handleStyleChange}
                              contentItem={{title:"与文本填匹配",type:"text",disabled:"disabled",defaultValue:"0,0,0,0",id:"icon-text-fit-padding"}}/>
            <StyleContentItem handleStyleChange={this.handleStyleChange}
            ...
            <StyleContentItem handleStyleChange={this.handleStyleChange}
                ...
                inputItems:[{title:"右",value:layerStyle.layout["icon-offset"]?layerStyle.layout["icon-offset"][0]:0},{title:"下",value:layerStyle.layout["icon-offset"]?layerStyle.layout["icon-offset"][1]:0}]}}/>
            <StyleContentItem handleStyleChange={this.handleStyleChange}
                              contentItem={{title:"文本倾斜锚点",type:"radio-group",id:"text-pitch-alignment",style:{marginTop:"30px"},defaultValue:layerStyle.layout["text-pitch-alignment"]||"map",
            ...
            <StyleContentItem handleStyleChange={this.handleStyleChange}
                              contentItem={{title:"文本允许重叠",type:"radio-group",id:"text-allow-overlap",style:{marginTop:"30px"},defaultValue:layerStyle.layout["text-allow-overlap"]||false,
                inputItems:[{title:"是",value:true},{title:"否",value:false}]}}/>
            <StyleContentItem handleStyleChange={this.handleStyleChange}
